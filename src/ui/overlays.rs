...
pub fn render_process_details_modal(
    ...
    let theme = crate::ui::theme::get_theme(true, Color::Rgb(0, 245, 255));
...
pub fn render_help_modal(f: &mut Frame, parent: Rect) {
    use crate::ui::layout_helpers::{centered_rect, format_help_row};
...
pub use crate::chrome::embedded_docs::DOC_FILES;
